...
const PolicyPage = () => {
  return (
    <>
      ...
      <div className="p-4">
        <h1 className="text-2xl">Privacy Policy for Event Friends</h1>
       <p className="my-2">Last updated: June 15, 2023</p>
       <p className="my-2">This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your
          information when You use the Service and tells You about Your privacy rights and how the law protects
          You.</p>
       <p className="my-2">We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
          ...
          created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/"
                                          target="_blank" rel="noreferrer">TermsFeed Privacy Policy Generator</a>.</p>
        <h1 className="text-2xl my-6">Interpretation and Definitions</h1>
        <h2 className="text-xl my-4">Interpretation</h2>
       <p className="my-2">The words of which the initial letter is capitalized have meanings defined under the following
        ...
        <h2 className="text-xl my-4">Definitions</h2>
       <p className="my-2">For the purposes of this Privacy Policy:</p>
        <ul>
          <li>
           <p className="my-2"><strong>Account</strong> means a unique account created for You to access our Service or parts of
              our Service.</p>
          </li>
          <li>
           <p className="my-2"><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common
          ...
          <li>
           <p className="my-2"><strong>Application</strong> refers to Event Friends, the software program provided by the Company.
            </p>
          </li>
          <li>
           <p className="my-2"><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this
              Agreement) refers to Event Friends.</p>
          </li>
          <li>
           <p className="my-2"><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any
              other device by a website, containing the details of Your browsing history on that website among its
              many uses.</p>
          </li>
          <li>
           <p className="my-2"><strong>Country</strong> refers to: California, United States</p>
          </li>
          <li>
           <p className="my-2"><strong>Device</strong> means any device that can access the Service such as a computer, a
              cellphone or a digital tablet.</p>
          </li>
          <li>
           <p className="my-2"><strong>Personal Data</strong> is any information that relates to an identified or identifiable
              individual.</p>
          </li>
          <li>
           <p className="my-2"><strong>Service</strong> refers to the Application or the Website or both.</p>
          </li>
          <li>
           <p className="my-2"><strong>Service Provider</strong> means any natural or legal person who processes the data on
          ...
          <li>
           <p className="my-2"><strong>Third-party Social Media Service</strong> refers to any website or any social network
              website through which a User can log in or create an account to use the Service.</p>
          </li>
          <li>
           <p className="my-2"><strong>Usage Data</strong> refers to data collected automatically, either generated by the use of
              the Service or from the Service infrastructure itself (for example, the duration of a page visit).
            </p>
          </li>
          <li>
           <p className="my-2"><strong>Website</strong> refers to Event Friends, accessible from <a href="https://eventfriends.app"
                                                                                    rel="external nofollow noopener noreferrer"
                                                                                    target="_blank">https://eventfriends.app</a>
            </p>
          </li>
          <li>
           <p className="my-2"><strong>You</strong> means the individual accessing or using the Service, or the company, or other
              legal entity on behalf of which such individual is accessing or using the Service, as applicable.
            </p>
          </li>
        </ul>
        <h1 className="text-2xl my-6">Collecting and Using Your Personal Data</h1>
        <h2 className="text-xl my-4">Types of Data Collected</h2>
        <h3>Personal Data</h3>
       <p className="my-2">While using Our Service, We may ask You to provide Us with certain personally identifiable information
       ...
       <p className="my-2">Usage Data may include information such as Your Device&apos;s Internet Protocol address (e.g. IP address),
          browser type, browser version, the pages of our Service that You visit, the time and date of Your visit,
          the time spent on those pages, unique device identifiers and other diagnostic data.</p>
       <p className="my-2">When You access the Service by or through a mobile device, We may collect certain information
       ...
       <p className="my-2">We may also collect information that Your browser sends whenever You visit our Service or when You
          access the Service by or through a mobile device.</p>
        <h3>Information from Third-Party Social Media Services</h3>
       <p className="my-2">The Company allows You to create an account and log in to use the Service through the following
       ...
       <p className="my-2">If You decide to register through or otherwise grant us access to a Third-Party Social Media Service,
          ...
          that account.</p>
       <p className="my-2">You may also have the option of sharing additional information with the Company through Your
          Third-Party Social Media Service&apos;s account. If You choose to provide such information and Personal Data,
       ...
       <p className="my-2">We use Cookies and similar tracking technologies to track the activity on Our Service and store certain
       ...
       <p className="my-2">Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer
       ...
       <p className="my-2">We use both Session and Persistent Cookies for the purposes set out below:</p>
        <ul>
          <li>
           <p className="my-2"><strong>Necessary / Essential Cookies</strong></p>
           <p className="my-2">Type: Session Cookies</p>
           <p className="my-2">Administered by: Us</p>
           <p className="my-2">Purpose: These Cookies are essential to provide You with services available through the Website and
          ...
          <li>
           <p className="my-2"><strong>Cookies Policy / Notice Acceptance Cookies</strong></p>
           <p className="my-2">Type: Persistent Cookies</p>
           <p className="my-2">Administered by: Us</p>
           <p className="my-2">Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
          </li>
          <li>
           <p className="my-2"><strong>Functionality Cookies</strong></p>
           <p className="my-2">Type: Persistent Cookies</p>
           <p className="my-2">Administered by: Us</p>
           <p className="my-2">Purpose: These Cookies allow us to remember choices You make when You use the Website, such as
       ...
       <p className="my-2">For more information about the cookies we use and your choices regarding cookies, please visit our
          Cookies Policy or the Cookies section of our Privacy Policy.</p>
        <h2 className="text-xl my-4">Use of Your Personal Data</h2>
       <p className="my-2">The Company may use Personal Data for the following purposes:</p>
        <ul>
          <li>
           <p className="my-2"><strong>To provide and maintain our Service</strong>, including to monitor the usage of our
              Service.</p>
          </li>
          <li>
           <p className="my-2"><strong>To manage Your Account:</strong> to manage Your registration as a user of the Service. The
          ...
          <li>
           <p className="my-2"><strong>For the performance of a contract:</strong> the development, compliance and undertaking of
          ...
          <li>
           <p className="my-2"><strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or other equivalent
          ...
          <li>
           <p className="my-2"><strong>To provide You</strong> with news, special offers and general information about other
          ...
          <li>
           <p className="my-2"><strong>To manage Your requests:</strong> To attend and manage Your requests to Us.</p>
          </li>
          <li>
           <p className="my-2"><strong>For business transfers:</strong> We may use Your information to evaluate or conduct a
          ...
          <li>
           <p className="my-2"><strong>For other purposes</strong>: We may use Your information for other purposes, such as data
       ...
       <p className="my-2">We may share Your personal information in the following situations:</p>
        ...
        <h2 className="text-xl my-4">Retention of Your Personal Data</h2>
       <p className="my-2">The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in
       ...
       <p className="my-2">The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally
          ...
          time periods.</p>
        <h2 className="text-xl my-4">Transfer of Your Personal Data</h2>
       <p className="my-2">Your information, including Personal Data, is processed at the Company&apos;s operating offices and in any
          ...
          jurisdiction.</p>
       <p className="my-2">Your consent to this Privacy Policy followed by Your submission of such information represents Your
          agreement to that transfer.</p>
       <p className="my-2">The Company will take all steps reasonably necessary to ensure that Your data is treated securely and
        ...
        <h2 className="text-xl my-4">Delete Your Personal Data</h2>
       <p className="my-2">You have the right to delete or request that We assist in deleting the Personal Data that We have
          collected about You.</p>
       <p className="my-2">Our Service may give You the ability to delete certain information about You from within the
          Service.</p>
       <p className="my-2">You may update, amend, or delete Your information at any time by signing in to Your Account, if you
          ...
          provided to Us.</p>
       <p className="my-2">Please note, however, that We may need to retain certain information when we have a legal obligation or
          lawful basis to do so.</p>
        <h2 className="text-xl my-4">Disclosure of Your Personal Data</h2>
        <h3>Business Transactions</h3>
       <p className="my-2">If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be
       ...
       <p className="my-2">Under certain circumstances, the Company may be required to disclose Your Personal Data if required to
          do so by law or in response to valid requests by public authorities (e.g. a court or a government
          agency).</p>
        <h3>Other legal requirements</h3>
       <p className="my-2">The Company may disclose Your Personal Data in the good faith belief that such action is necessary
          to:</p>
        <ul>
        ...
        <h2 className="text-xl my-4">Security of Your Personal Data</h2>
       <p className="my-2">The security of Your Personal Data is important to Us, but remember that no method of transmission over
          the Internet, or method of electronic storage is 100% secure. While We strive to use commercially
          acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
        <h1 className="text-2xl my-6">Children&apos;s Privacy</h1>
       <p className="my-2">Our Service does not address anyone under the age of 13. We do not knowingly collect personally
       ...
       <p className="my-2">If We need to rely on consent as a legal basis for processing Your information and Your country
          requires consent from a parent, We may require Your parent&apos;s consent before We collect and use that
          information.</p>
        <h1 className="text-2xl my-6">Links to Other Websites</h1>
       <p className="my-2">Our Service may contain links to other websites that are not operated by Us. If You click on a third
          party link, You will be directed to that third party&apos;s site. We strongly advise You to review the
          Privacy Policy of every site You visit.</p>
       <p className="my-2">We have no control over and assume no responsibility for the content, privacy policies or practices of
          any third party sites or services.</p>
        <h1 className="text-2xl my-6">Changes to this Privacy Policy</h1>
       <p className="my-2">We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the
          new Privacy Policy on this page.</p>
       <p className="my-2">We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming
          effective and update the &quot;Last updated&quot; date at the top of this Privacy Policy.</p>
       <p className="my-2">You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy
       ...
       <p className="my-2">If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul>
          <li>By email: gabrielle@eventfriends.app</li>
        </ul>
      </div>
    </>
  )
