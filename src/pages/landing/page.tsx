...
const LandingPage = () => {
  ...
  return (
    <IonPage>
      <IonContent >
        <div className=" relative scroll-smooth bg-black overflow-hidden ">
          <div className="w-full h-screen bg-black snap-start">
            <div className="flex flex-col items-center h-full">
              ...
              <div className="flex gap-4">
                ...
                <div className="text-lightYellow text-2xl my-4">App Coming soon!</div>
    ...
    <div>
      ...
      >
       ...
       //     className="left-1/2"
        ...
        <div className="h-[342px] md:h-[600px]">
        <motion.img
          className="w-full  max-w-[200px] md:max-w-[300px] absolute border border-black mt-32"
          initial={{left: "-5%", top: "50%", rotate: 45}}
...
const Div3 = () => {
  ...
  return (
    <motion.div
      className="my-8 flex justify-center text-center w-full bg-black snap-start text-5xl relative z-30 text-lightYellow div2 div3 py-16"
      ref={ref}
      style={{ marginTop: "-44px" }}
    >
      <div className="min-h-[800px] max-w-[800px] w-full relative">
        <div className="my-4">
          <motion.div
        ...
        <div className="h-[342px] md:h-[514px] my-16">
          <motion.img
            className="w-full max-w-[200px] md:max-w-[300px] absolute  border border-black"
            initial={{rotateY: 180, left: "95%"}}
            whileInView={{rotateY: 0, left: "0%"}}
...
const Div4 = () => {
  ...
  return (
      <motion.div
        className="mt-8 min-h-[800px] w-full text-lightYellow  bg-black snap-start text-center text-5xl relative z-30 div2 div3 py-16 flex justify-center"
        ref={ref}
        style={{ marginTop: "-44px" }}
      >
        ...
        <motion.div
          className=""
          whileInView={{opacity:1, transform: "translateX(00%)"}}
          initial={{opacity: 0, transform: "translateX(100%)"}}
          transition={{duration: 1, ease: "circIn"}}
        >
          Promote
        ...
        <motion.div
          ...
          <div className="h-[342px] md:h-[514px] my-16">
        <motion.img
          className="w-full max-w-[200px] md:max-w-[300px] absolute left-1/4 border border-black mt-8"
          initial={{transform: "translateY(-100%) translateX(-50%) rotateY(180deg)"}}
          whileInView={{transform: "translateY(0) translateX(-50%) rotateY(0deg)"}}
          transition={{duration: 1, ease: "easeOut"}}
          src={ss1}
        />
        <motion.img
          className="w-full max-w-[200px] md:max-w-[300px] left-1/2 absolute border border-black mt-8"
          initial={{transform: "translateY(100%) rotateY(180deg)"}}
          whileInView={{transform: "translateY(0) rotateY(0deg)"}}
          transition={{duration: 1, ease: "easeOut"}}
          src={ss2}
        />
          </div>
          <motion.div
            ...
            className="my-16 text-center text-4xl"
          >
          Reach a growing social network
          </motion.div>
        </div>
      </motion.div>
  )
...
const Div5 = () => {
  ...
  return (
      <motion.div
        className="mt-8 min-h-[800px] w-full bg-lightYellow  snap-start text-center text-5xl relative z-30 div2 div3 py-16 flex justify-center"
        ref={ref}
      >
        <div className="w-full max-w-[800px] relative">
        <div className="my-4">
        ...
        <motion.img
          className="w-full max-w-[200px] md:max-w-[300px] absolute border border-black mt-8"
          initial={{right: "95%", transform: "rotateZ(180deg)"}}
          whileInView={{right: "0%", transform: "rotateZ(0deg)"}}
          transition={{duration: 1, ease: "easeOut"}}
          src={ss1}
        />
        <motion.img
          className="w-full max-w-[200px] md:max-w-[300px] absolute border border-black mt-8"
          initial={{left: "95%", transform: "rotateZ(180deg)"}}
          whileInView={{left: "0%", transform: "rotateZ(0deg)"}}
          transition={{duration: 1, ease: "easeOut"}}
          src={ss2}
        />
          </div>
          <motion.div
            ...
            className="my-16 text-center text-4xl"
          >
            Experience the events you love
          </motion.div>
        </div>
      </motion.div>
  )
