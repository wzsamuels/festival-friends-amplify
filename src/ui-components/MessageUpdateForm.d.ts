...
export declare type MessageUpdateFormValidationValues = {
    ...
    senderProfileID?: ValidationFunction<string>;
    receiverProfileID?: ValidationFunction<string>;
};
...
export declare type MessageUpdateFormOverridesProps = {
    ...
    senderProfileID?: PrimitiveOverrideProps<TextFieldProps>;
    receiverProfileID?: PrimitiveOverrideProps<TextFieldProps>;
} & EscapeHatchProps;
