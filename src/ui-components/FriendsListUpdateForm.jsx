...
export default function FriendsListUpdateForm(props) {
  const {
    id: idProp,
    friendsList: friendsListModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = friendsListRecord
      ? { ...initialValues, ...friendsListRecord }
      : initialValues;
  ...
  const [friendsListRecord, setFriendsListRecord] =
    React.useState(friendsListModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(FriendsList, idProp)
        : friendsListModelProp;
      setFriendsListRecord(record);
    };
    queryData();
  }, [idProp, friendsListModelProp]);
  React.useEffect(resetStateValues, [friendsListRecord]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            FriendsList.copyOf(friendsListRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "FriendsListUpdateForm")}
      {...rest}
    >
      <ArrayField
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || friendsListModelProp)}
