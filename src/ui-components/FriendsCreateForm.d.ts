...
export declare type FriendsCreateFormProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: FriendsCreateFormInputValues) => FriendsCreateFormInputValues;
    onSuccess?: (fields: FriendsCreateFormInputValues) => void;
    onError?: (fields: FriendsCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: FriendsCreateFormInputValues) => FriendsCreateFormInputValues;
    onValidate?: FriendsCreateFormValidationValues;
} & React.CSSProperties>;
export default function FriendsCreateForm(props: FriendsCreateFormProps): React.ReactElement;
