...
export default function CollegeGroupCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CollegeGroup(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CollegeGroupCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
