...
export declare type FriendsUpdateFormProps = React.PropsWithChildren<{
    ...
    id?: string;
    friends?: Friends;
    onSubmit?: (fields: FriendsUpdateFormInputValues) => FriendsUpdateFormInputValues;
    onSuccess?: (fields: FriendsUpdateFormInputValues) => void;
    onError?: (fields: FriendsUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: FriendsUpdateFormInputValues) => FriendsUpdateFormInputValues;
    onValidate?: FriendsUpdateFormValidationValues;
} & React.CSSProperties>;
export default function FriendsUpdateForm(props: FriendsUpdateFormProps): React.ReactElement;
