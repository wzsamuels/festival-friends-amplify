  ...
  if(isSubmitted) {
    return (
      <div className='flex flex-col justify-center items-center mt-4 p-4'>
        ...
        <p className='my-6'>Your profile has been submitted for verification. You&asop;ll receive an email at the address you used to sign up for this account once the process has been completed.</p>
        <p>If you&asop;ve received confirmation that your profile has been verified but are still seeing this message, please try refreshing this page.</p>
      </div>
    )
  }
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-4 p-4'>
      ...
      <div className='flex justify-center w-full'>
        <form className='w-full max-w-4xl' onSubmit={handleSubmit(createNewProfile)}>
          <div className='flex flex-col md:flex-row'>
            <InputWrapper className='my-4 flex-1'>
              <Label className=''>First Name</Label>
              <Input className='mr-2' {...register("firstName", {required: true})}/>
            </InputWrapper>
            <InputWrapper className='my-4 flex-1'>
          ...
          <div className='flex flex-col md:flex-row'>
            ...
            <InputWrapper className='my-4 flex-1'>
              <Label>State</Label>
              <select placeholder=''  {...register('state', {required: true})} name="state">
