...
const GroupsPage = () => {
  ...
  if (
    ...
    return (
      <>
        <Header />
        <div className='bg-[url("https://twinsilver.mo.cloudinary.net/eventfriends/public/website/group.png?tx=q_auto,f_auto")] w-full bg-cover relative min-h-[calc(100vh-5rem)] h-full'>
