    ...
    <>
      ...
      <section className='w-full p-4'>
        <div className=' my-4 flex justify-between'>
          ...
          <Button onClick={() => setIsNewRideModalOpen(true)}>Create Ride</Button></div>
        {
          rides.length > 0 ?
      ...
      { event && <NewRideModal isOpen={isNewRideModalOpen} setIsOpen={setIsNewRideModalOpen} event={event}/> }
